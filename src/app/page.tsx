...
const translations = {
  en: { flag:"US", title:(r:Role)=>({girlfriend:"Your Perfect AI Companion",boyfriend:"Your Perfect AI Companion",friend:"Your Perfect AI Companion",girlfriend_friend:"Your Perfect AI Companion"}[r]), hi:(r:Role)=>({girlfriend:"Hey baby ❤️ I'm here 24-7... What do you want tonight?",boyfriend:"Hey beautiful ❤️ Always here for you...",friend:"Yo! What's good bro?",girlfriend_friend:"Girl!! Finally here! Spill the tea ❤️"}[r]), placeholder:"Type a message...", tagline:"24-7 · no drama · 100% private" },
